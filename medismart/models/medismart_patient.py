...
class medismartPatient(models.Model):
    ...
    admission_date = fields.Date(default=fields.Date.today(), string='Admission Date',tracking=True)
    discharge_date = fields.Date(default=fields.Date.today() + relativedelta(days=3), string='Discharge Date',tracking=True)
